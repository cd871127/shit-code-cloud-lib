 ...
 * @date 11/7/20
 **/
public interface TraceRedisMessageHandler<T> extends RedisMessageHandler<T> {

    Logger logger = LoggerFactory.getLogger(TraceRedisMessageHandler.class);
    ...
    default void handleMessage(RedisMessage<T> redisMessage) {
        ...
        TraceRedisMessage<T> traceRedisMessage = (TraceRedisMessage<T>) redisMessage;
        Span span;
        Tracer tracer = Tracing.currentTracer();
        Map<String, String> traceContextMap = traceRedisMessage.getTraceContextMap();
        ...
        try (Tracer.SpanInScope scope = tracer.withSpanInScope(span)) {
            ...
            handle(traceRedisMessage.getBody());
